...
from .views import WorkspaceListCreateView, WorkspaceDetailsView, WorkspaceMemberListCreateView, WorkspaceMemberDetailsView
...
urlpatterns = [
    ...
    path('workspaces/<int:workspace_id>/members/<int:member_id>/', WorkspaceMemberDetailsView.as_view(), name="workspace-member-details")
]